...
INSERT INTO Player(P_Name,P_Pos,P_Age,P_Sex,P_Weight,P_Height,P_Nation,P_Rating,P_Medical_Condition,P_Salary,P_Contract_Year,P_Description,Team_ID)
...
INSERT INTO Coach(C_Name,C_Formation,C_Designation,C_Age,C_Sex,C_Medical_Condition,C_Salary,C_Contract_Year,C_Performance_Bonus,C_Release_Date,C_Description,Team_ID)
VALUES('Ronald Koeman','4-3-3','Head',58,'M','Good',4500000,1,5000,'12-12-2022','Alright',40)

INSERT INTO Coach(C_Name,C_Formation,C_Designation,C_Age,C_Sex,C_Medical_Condition,C_Salary,C_Contract_Year,C_Performance_Bonus,C_Release_Date,C_Description,Team_ID)
VALUES('Herik Larsson','5-3-2','Assistant',50,'M','Good',300000,1,1500,'2022-07-15','Alright',41)

INSERT INTO Coach(C_Name,C_Formation,C_Designation,C_Age,C_Sex,C_Medical_Condition,C_Salary,C_Contract_Year,C_Performance_Bonus,C_Release_Date,C_Description,Team_ID)
VALUES('Alfred Schreuder','4-2-4','Assistant',48,'M','Good',220000,1,1755,'2022-10-15','Alright',42)

INSERT INTO Coach(C_Name,C_Formation,C_Designation,C_Age,C_Sex,C_Medical_Condition,C_Salary,C_Contract_Year,C_Performance_Bonus,C_Release_Date,C_Description,Team_ID)
VALUES('Jose De La Fuente','3-4-3','GK Coach',50,'M','Good',350000,1,2000,'2022-12-15','Alright',40)

INSERT INTO Coach(C_Name,C_Formation,C_Designation,C_Age,C_Sex,C_Medical_Condition,C_Salary,C_Contract_Year,C_Performance_Bonus,C_Release_Date,C_Description,Team_ID)
VALUES('Albert Roca','4-4-2','Fitness',58,'M','Good',250000,2,0500,'2023-07-12','Alright',40)
...
SELECT * FROM Player WHERE C_ID LIKE '%H%' OR C_Name LIKE '%H%' OR C_Formation LIKE '%H%' OR C_Designation LIKE '%H%' OR C_Age LIKE '%H%' OR C_Sex LIKE '%H%' OR C_Medical_Condition LIKE '%H%' OR C_Salary LIKE '%H%'
...
SELECT * FROM Tournament tr JOIN TEAM t ON tr.Team_ID = t.Team_ID AND Tm_ID=1802
