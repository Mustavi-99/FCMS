        ...
        if (cIDBox.getText().toString().equals("")) {
            ...
            try {
                ...
                if (resultSet.next() && !formationBox.getValue().equals("")) {
                    ...
                    String insertsql = "INSERT INTO Coach(C_Name,C_Formation,C_Designation,C_Age,C_Sex,C_Medical_Condition,C_Salary,C_Contract_Year,C_Performance_Bonus,C_Description,Team_ID)" +
