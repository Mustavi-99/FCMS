            ...
            if (pMale.isSelected()) {
                ...
                if (!primarypos.getValue().equals("")) {
                    try {
                        ...
                        String insertsql = "INSERT INTO Player(P_Name,P_Pos,P_Age,P_Sex,P_Weight,P_Height,P_Nation,P_Rating,P_Medical_Condition,P_Salary,P_Contract_Year,P_Description,Team_ID)" +
